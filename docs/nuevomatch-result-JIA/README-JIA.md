...
./bin/tool_classifier.exe -m nuevomatch -l -in acl1_100k.data --trace ../../classbench_set/ipv4-trace/acl1_100k_trace --parallel 1 --trace-silent --max-subsets 1 --remainder-type tuplemerge --force-remainder-build -v 3
